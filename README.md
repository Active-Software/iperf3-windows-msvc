Windows MSVC community build
============================

This repository includes a native Visual Studio 2022 / MSVC Windows port for
`iperf3.exe` on Windows 11+ with `x64` and `ARM64` Release builds. It is an
unofficial community build maintained by Daniel Doguet / Active-Software.

See [README_WINDOWS.md](README_WINDOWS.md) for Windows build commands, port
notes, and release packaging details.
